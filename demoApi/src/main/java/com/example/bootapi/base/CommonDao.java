...
public class CommonDao {
	 ...
	 * @return
	 */
	public <T> Page<T> queryForPageNative(String sql, Map<String, Object> params, PageRequest pageRequst, Class<T> clazz) {
	 ...
	 * @return
	 */
	public Page<Map<String, Object>> queryForPageNative(String sql, Map<String, Object> params, PageRequest pageRequst) {
		String countSql = "select count(1) from (" + sql + ") as tmp";
		Query queryCount  = em.createNativeQuery(countSql);
